...
// barcode scanfeld
    ...
    if ($eanorder == "") {
        ...
        echo "<tr>";
        echo "<td colspan =2>";
        echo "<p>Bitte <strong>scannen</strong> Sie die <strong>Auftragsnummer</strong> oder die <strong>EAN-Nummer</strong> des <strong>Artikels</strong></p>";
        echo "</td><td>";
        echo "<p><input autofocus type=\"text\" name=\"order\" onchange=\"this.form.submit()\" style=\"font-family: Arial; font-size: 18pt; height: 24px\" value=\"" . $eanorder . "\"></p>";
        echo "</td></tr>";
        echo "<tr><td colspan=2>";
        echo "<p><strong>Oder:</strong> Suchen Sie nach dem Arikel</p>";
        echo "</td><td>";

        echo "<input type=\"text\" id=\"CityLocal\" style=\"font-family: Arial; font-size: 18pt; height: 24px\" value autocomplete=\"off\" class=\"ac_input\">";
        ...
        if ($order != "") {
            ...
            if ($order_db->entity_id != "") {
                ...
                if (!$orderfound && !$articlefound){
                    ...
                    echo "<span style=\"font-size: 12pt;color:#ff0000;\" >Bestellung " . $order . " existiert nicht.</span><br>";
                    echo "<br><br>";
                }
            }
        }
        ...
        if ($func == "WARES") {
            echo "<button class=\"btnExample\" style=\"width:400px\">nächsten Auftrag bearbeiten</button><br>";
        }
        if ($func == "WARES" && $orderfound) {
            echo "<button class=\"btnExample\" style=\"width:400px\" onclick='return CheckScan();'>Auftragsreservierung durchführen</button><br>";
            echo "<button class=\"btnExample\" style=\"width:400px\">Reservierung STORNIEREN</button><br>";
        }
        if ($func == "WARES" && $articlefound) {
            echo "<button class=\"btnExample\" style=\"width:400px\" onclick='return BookArticle(" . $eanorder . ");'>Artikelbuchung durchführen</button><br>";
        }
    }
}
...
<script type="text/javascript">
    ...
    function BookArticle (ean){
        alert ean + " wird gebucht.";
    }
